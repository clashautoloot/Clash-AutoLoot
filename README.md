...
With **Star Bonus** on, the bot keeps going until you have no star bonus to collect, then it stops on its own.

### Multi-run

This uses your player list, enter the supercell ID's of your account, case sensitive. Order matters: that’s the order it visits accounts. 
